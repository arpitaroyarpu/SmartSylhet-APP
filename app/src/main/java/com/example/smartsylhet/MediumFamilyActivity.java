...
public class MediumFamilyActivity extends AppCompatActivity {
...
ob1.setImgname(R.drawable.school);
        ...
        ob1.setDesc("3 Bed Room  and 1 Single Washroom"+
...
holder.add(ob1);
        ...
        ob3.setDesc("2 Bed Room 1 attached Washroom and 1 Single Washroom"+
                ",1 Dining Room and Kitchen"+",Per Month - 13000tk only including Gas Services"+
                "It is special because its near the main point also all facilities are available"+
                "If you need any kind of information please contact us");
        holder.add(ob3);
        ...
        ob4.setDesc("3 Bed Room 2 attached Washroom and 1 Single Washroom"+
        ...
        ob5.setDesc("2 Bed Room 2 attached Washroom"+
                ",1 Dining Room and Kitchen"+",Per Month - 10000tk only including Gas Services"+
                "It is special because its near the main point also all facilities are available"+
                "If you need any kind of information please contact us");
        holder.add(ob5);
        ...
        ob6.setDesc("2 Bed Room 2 attached Washroom"+
                ",1 Dining Room and Kitchen"+",Per Month - 9700tk only including Gas Services"+
                "It is special because its near the main point also all facilities are available"+
                "If you need any kind of information please contact us");
        holder.add(ob6);
        ...
        ob7.setDesc("3 Bed Room 2 attached Washroom and 1 Single Washroom"+
                ",1 Dining Room and Kitchen"+",Per Month - 12000tk only including Gas Services"+
                "It is special because its near the main point also all facilities are available"+
                "If you need any kind of information please contact us");
        holder.add(ob7);
        ...
        ob9.setDesc("3 Bed Room 2 attached Washroom "+
                ",1 Dining Room and Kitchen"+",Per Month - 12000tk only including Gas Services"+
                "It is special because its near the main point also all facilities are available"+
                "If you need any kind of information please contact us");
        holder.add(ob9);
